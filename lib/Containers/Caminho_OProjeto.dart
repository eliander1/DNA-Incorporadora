...
class OProjetoCDA4 extends StatefulWidget {
  const OProjetoCDA4({Key? key}) : super(key: key);

  @override
  State<OProjetoCDA4> createState() => _OProjetoCDA4State();
}

class _OProjetoCDA4State extends State<OProjetoCDA4> {
  @override
  Widget build(BuildContext context) {
    ...
    child: Image.asset("assets/CaminhoDasAguas/texto-Caminho.png",width: 286, height: 418,))
    ]);
  }
}
